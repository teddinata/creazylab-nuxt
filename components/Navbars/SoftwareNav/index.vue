        ...
        <div class="nav-side">
          <div class="d-flex ps-4">
            ...
            <div class="dropdown" @mousemove="handleMouseMove" @mouseleave="handleMouseLeave">
              <button class="icon-35 dropdown-toggle p-0 border-0 bg-transparent rounded-circle img-cover text-white" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
