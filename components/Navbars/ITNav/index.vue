<template>
  <nav class="navbar navbar-expand-lg navbar-dark style-2 position-absolute w-100 p-0" ref="navbarRef">
    <div class="container">
        ...
        <div class="nav-side">
          <div class="qoute-nav ps-4">
            ...
            <a href="#" class="cart-icon me-3">
              ...
              <span class="cart-num ms-1">
                2
              </span>
            </a>
            <NuxtLink to="/page-contact-5" class="btn sm-butn border text-white radius-9 hover-darkBlue">
